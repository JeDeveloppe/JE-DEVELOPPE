...
$helpers = [
    [
        '<img src="https://img.icons8.com/doodle/48/000000/icons8-new-logo.png"/>','Icones8','https://icones8.fr/'
    ],
    [
        '<img src="https://img.icons8.com/windows/50/000000/font-awesome-flag.png"/>','Fontawesome','https://fontawesome.com/'
    ],
    [
      ...
      </svg>','CSS Gradient','https://cssgradient.io/'
    ],
    [
   ...
   </svg>','Coolors','https://coolors.co/'
    ]
];
?>
<!-- Skills-->
<section class="resume-section" id="helpers">
    <div class="resume-section-content">
        <h2 class="mb-5">Helpers</h2>
        <div class="subheading mb-3">Liste non exhaustive des "endroits" ou je pioche pour construire...</div>
        <ul class="lookleft list-inline dev-icons d-flex justify-content-center justify-content-md-start flex-wrap">
            <?php
                foreach($helpers as $helper){
                    echo '<li class="card list-inline-item d-flex flex-column justify-content-center align-items-center col-5 m-2 col-sm-3 col-md-2 col-lg-2 col-xl-2 m-lg-2 shadow">
                            <div>'.$helper[0].'</div>
                            <div class="col h6">'.$helper[1].'</div>
                            <a href="'.$helper[2].'" target="_blank" class="btn btn-secondary p-1 mb-1">Voir</a>
                        </li>';
                }
            ?>
