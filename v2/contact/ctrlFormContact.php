...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(empty($_POST['recaptcha-response'])){
        $_SESSION['alertMessage-contact'] = "Captcha Google vide...";
        $_SESSION['alertMessageConfig-contact'] = "warning";
        ...
        if(empty($response) || is_null($response)){
            $_SESSION['alertMessage-contact'] = "Pas de réponse du Captcha Google veuillez réessayer... ";
            $_SESSION['alertMessageConfig-contact'] = "warning";
            header('Location: /#contact');
            exit();
        }else{
            ...
            if($data->success){
                require("../fonctions/valid_donnees.php");
                ...
                *bien la forme attendue...*/
                if (!empty($content)
                    ...
                    try{
                        ...
                        if(!$mail->send()) {
                            $_SESSION['alertMessage-contact'] = "Bug, message non envoyé :(";
                            $_SESSION['alertMessageConfig-contact'] = "warning";
                            header("Location: /#contact");
                            echo 'Mailer Error: ' . $mail->ErrorInfo;
                        } else {
                            $_SESSION['alertMessage-contact'] = "Message bien envoyé, je vous remercie !";
                            $_SESSION['alertMessageConfig-contact'] = "success";
                            header("Location: /#contact");
                            exit();
                        }
                    }
                    ...
                    $_SESSION['alertMessage-contact'] = "Un champs n' était pas correct, veuillez rééssayer !";
                    $_SESSION['alertMessageConfig-contact'] = "danger";
                    header("Location: /#contact");
                    exit();
                }
            }
    ...
    $_SESSION['alertMessage'] = "Mauvaise requête POST ou GET!";
