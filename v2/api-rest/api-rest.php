<!-- API REST -->
<section class="resume-section" id="api-rest">
    <div class="resume-section-content">
    <h2 class="mb-5">API REST avec Curl</h2>
    <div class="row my-4">
            ...
            <div class="row justify-content-around align-items-start mt-4" id="gens">
                <?php
                    ...
                    if($json_reponse === false || curl_getinfo($curl, CURLINFO_HTTP_CODE) !== 200){
                        echo '<h1>Le serveur n\'a pas répondu dans les temps... (404) </h1>';
                        ...
                        foreach($data as $people){
                            echo '  <div class="card col-11 col-sm-8 col-md-5 col-lg-5 col-xl-5 p-0 m-1">
